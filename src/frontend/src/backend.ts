...
import type { ThreatResult as _ThreatResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async classifyAudio(arg0: string, arg1: string): Promise<{
        __kind__: "ok";
        ok: ThreatResult;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.classifyAudio(arg0, arg1);
    ...
    async classifyImage(arg0: string, arg1: string, arg2: string): Promise<{
        __kind__: "ok";
        ok: ThreatResult;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.classifyImage(arg0, arg1, arg2);
                return from_candid_variant_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async computeEscapePath(arg0: string, arg1: Array<string>): Promise<{
        __kind__: "ok";
        ok: Array<string>;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.computeEscapePath(arg0, arg1);
    ...
    async generateEvacuationInstruction(arg0: string, arg1: Array<string>): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.generateEvacuationInstruction(arg0, arg1);
    ...
    async generateTTS(arg0: string): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.generateTTS(arg0);
                return from_candid_variant_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFloorPlan(): Promise<Array<RoomData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFloorPlan();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLatestThreat(): Promise<ThreatResult | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestThreat();
    ...
    async getOccupiedRooms(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOccupiedRooms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSimulatorState(): Promise<ThreatResult | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSimulatorState();
                return from_candid_opt_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetSimulator(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetSimulator();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setGoogleTtsApiKey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setGoogleTtsApiKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setOccupied(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setOccupied(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async simulateFire(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.simulateFire(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ThreatResult]): ThreatResult | null {
